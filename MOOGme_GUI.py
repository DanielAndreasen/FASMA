...
def _parser():
    ...
    parser.add_argument('--surfacegravity',     help='Input initial gravity',          default=4.44,  type=float, metavar='Surface gravity')
    ...
    parser.add_argument('--Fixteff',            help='Fix temperature',     action='store_true', metavar='Fix temperature')
    parser.add_argument('--Fixgravity',         help='Fix gravity',         action='store_true', metavar='Fix gravity')
    parser.add_argument('--FixFeH',             help='Fix metallicity',     action='store_true', metavar='Fix [Fe/H]')
    parser.add_argument('--Fixmicroturbulence', help='Fix microturbulence', action='store_true', metavar='Fix microturbulence')
    ...
    parser.add_argument('--EPslope',            help='EP slope to converge', default=0.001, type=float, metavar='EP slope')
    parser.add_argument('--RWslope',            help='RW slope to converge', default=0.003, type=float, metavar='RW slope')
    parser.add_argument('--Fedifference',       help='Difference between FeI and FeII', default='0.000',   type=float, metavar='|<Fel>-<Fell>|')
