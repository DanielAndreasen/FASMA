...
def read_synth_intervals(fname):
    ...
    tbhdu = pyfits.BinTableHDU.from_columns([pyfits.Column(name='wavelength', format='D', array=wavelength), pyfits.Column(name='flux', format='D', array=flux)])
    tbhdu.writeto('spec.fits', clobber=True)
    return wavelength, flux
